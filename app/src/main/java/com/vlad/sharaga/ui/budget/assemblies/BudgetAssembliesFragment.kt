...
import com.vlad.sharaga.core.adapter.recycler.fingerprints.BudgetAssemblyFingerprint
import com.vlad.sharaga.core.adapter.recycler.fingerprints.BudgetAssemblyItem
import com.vlad.sharaga.core.util.toPx
import com.vlad.sharaga.databinding.FragmentBudgetAssembliesBinding
...
class BudgetAssembliesFragment : Fragment() {
    ...
    private val adapter by lazy {
        FingerprintAdapter(listOf(BudgetAssemblyFingerprint(::onBudgetAssemblyClick)))
    }
